...
public class Utils {
    public final static  String ACCESS_TOKEN = "PtCp5D-vUnsENlaXsJ8enRpPUpt-2bJderfxllZN8Rtyc0fLrs01Bge3OXqPwr6t";
    ...
    public final static String AUTHENTICATION_TOKEN = "authenticationToken";

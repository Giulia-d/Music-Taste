...
public class SongRecyclerViewAdapter extends RecyclerView.Adapter<SongRecyclerViewAdapter.SongViewHolder>{
    ...
    public class SongViewHolder extends RecyclerView.ViewHolder {
        ...
        public SongViewHolder(@NonNull View itemView) {
            super(itemView);
            titleTextView = itemView.findViewById(R.id.tvlikedtitle);
            artistTextView = itemView.findViewById(R.id.tvlikedartist);
            imageSong = itemView.findViewById(R.id.imglikedSong);
        }

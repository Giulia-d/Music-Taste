...
public class NewsRecyclerViewAdapter extends RecyclerView.Adapter<NewsRecyclerViewAdapter.NewsViewHolder>{
    ...
    private NewsRecyclerViewAdapter.OnItemClickListener onItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(News response);
    }

    public NewsRecyclerViewAdapter(List<News> responseList, NewsRecyclerViewAdapter.OnItemClickListener onItemClickListener) {
    ...
    public NewsRecyclerViewAdapter.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new NewsRecyclerViewAdapter.NewsViewHolder(view);
    }
